...
using Telegram.Bot.Console.Extensions;
...
class Program
{
    ...
    static async Task Main()
    {
        ...
        _botClient.StartReceiving(BotHanddlers.UpdateHandler, BotHanddlers.ErrorHandler, _receiverOptions, cts.Token); // Запускаем бота
